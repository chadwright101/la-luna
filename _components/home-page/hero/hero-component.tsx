...
const HeroComponent = () => {
  return (
    <section className="max-w-[1280px] mx-auto relative">
      ...
      />
      <h1 className="absolute top-1/2 left-1/2 -translate-y-[55%] -translate-x-1/2 z-10 flex flex-col leading-[90%] max-w-[215px] text-center px-5 py-10 bg-white/80 rounded-[2px] text-[68px] font-thin uppercase tablet:text-[100px] tablet:max-w-[320px]">
        La Luna
